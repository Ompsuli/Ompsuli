...
I'm Python/Low-Code Data Engineer interested in building stuff related to data pipelines and architectures, AI & LLM and embedded systems.

Currently working on:
- Local LLM architetures / use-cases
- DE Optimization test-cases
- Learning rest of language stack ( ***C***, Rust/Go & TypeScript )
